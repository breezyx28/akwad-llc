...
export const _applicationList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  numberOfUsers: _mock.number.age(index),
  numberOfDownloads: _mock.number.age(index),
  numberOfSessions: _mock.number.age(index),
  visits: _mock.number.age(index),
  usageProcesses: _mock.number.age(index),
  brand: _mock.companyNames(index),
  avatarUrl: _mock.image.avatar(index),
}));
