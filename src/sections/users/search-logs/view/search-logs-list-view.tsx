...
import type { ISearchLogsItem, ISearchLogsTableFilters } from 'src/types/search-logs';
...
import { useGetSearchLogs, SEARCH_LOGS_ENDPOINT } from 'src/actions/search-logs';
